...
const QUICK_LINKS = [
  { to: '/tracker', icon: '🧠', label: '1-4-7 Tracker', desc: 'Continue your revision', gradient: 'linear-gradient(135deg, #667eea, #764ba2)' },
  { to: '/community', icon: '💬', label: 'Community', desc: 'Placement discussions', gradient: 'linear-gradient(135deg, #f093fb, #f5576c)' },
  { to: '/jobs', icon: '💼', label: 'Job Board', desc: 'Find opportunities', gradient: 'linear-gradient(135deg, #4facfe, #00f2fe)' },
  { to: '/alumni', icon: '🎓', label: 'Alumni Network', desc: 'Get referrals', gradient: 'linear-gradient(135deg, #43e97b, #38f9d7)' },
  { to: '/ai-analyzer', icon: '🤖', label: 'AI Analyzer', desc: 'Prep roadmap', gradient: 'linear-gradient(135deg, #fa709a, #fee140)' },
];
  ...
  return (
    <div style={{ padding: '32px 24px', maxWidth: 900, margin: '0 auto' }}>
      ...
      <div style={{
        ...
        <div style={{ fontSize: 26, fontWeight: 800, color: '#f1f5f9', marginBottom: 6 }}>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: 10 }}>
          ...
          <Link to="/tracker" style={{ fontSize: 12, color: '#FFD700', textDecoration: 'none', fontWeight: 600 }}>Continue →</Link>
        </div>
      </div>
        ...
        {QUICK_LINKS.map(link => (
          <Link key={link.to} to={link.to} style={{ textDecoration: 'none' }}>
            ...
            >
              ...
              <div style={{ fontSize: 32, marginBottom: 10 }}>{link.icon}</div>
      ...
      <div style={{
        ...
        <div style={{ fontSize: 12, color: '#64748b', marginBottom: 8 }}>⚡ CracKInterview — Your complete campus placement ecosystem</div>
